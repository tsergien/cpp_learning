...
Form::NotSignedException::NotSignedException(NotSignedException const & other){*this = other;}
Form::NotSignedException const & Form::NotSignedException::operator=(NotSignedException const & other){
	(void)other;
	return *this;
}
